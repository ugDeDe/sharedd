...
// Публичный дашборд блокировок (V7.9.11): /dashboard — страница с
...
// V7.9.12: интервалы < gapClusterMin (2 мин) в среднюю периодичность НЕ
...
// gapClusterMin (V7.9.12) — интервалы между банами короче этого порога
