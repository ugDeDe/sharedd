...
// Гейт молчания ноды (V7.9.8; унификация защёлок V7.9.10; V7.9.11 — GP-нога
...
//
// V7.9.11: GP-нога немоты УДАЛЕНА. Судьба «всё зелёное, кроме globalping»
...
//
// V7.9.11: немота по метрикам отныне с часами — netGate.mMutedSince:
...
// msgDead. Транзиентные эпизоды короче окна ведут себя ровно как V7.9.8.
//
// Сюда же сведён prune-карантин (429 + Retry-After с регистратора, V7.9.7):
...
type netGate struct {
	...
	mMutedSince time.Time // V7.9.11: непрерывная метрик-немота с часов (dead-килл); ноль — не молчим
